  ...
  return (
    <div className="bg-gray-800">
      <div className="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:py-16 lg:px-8">
        <div id="footerLinks" className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-8 xl:mt-0">
            ...
            <form className="mt-4 sm:flex sm:max-w-md">
              ...
              <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button className="flex items-center justify-center w-full px-5 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-indigo-500 border border-transparent rounded-md hover:bg-indigo-400 focus:outline-none focus:bg-indigo-400">
                  Subscribe
                </button>
              </div>
            </form>
